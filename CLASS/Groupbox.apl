.head 0 +  Application Description: SQLWindows 5.01 Jans Checkbox Class
.data CLASSPROPSSIZE
0000: 5C00
.enddata
.data CLASSPROPS
...
.head 3 -  System
.head 3 +  User
.head 4 -  ! For PAM_User messages for GROUPBOX.APL
.head 4 -  Number: GBAplMsgOffSet = SAM_User + 2100
.head 4 -  ! Message go up to AplOffSet + 99
.head 4 -  Number: GBAplConstOffSet = 1050
.head 4 -  !
.head 3 -  Enumerations
.head 2 -  Resources
.head 2 -  Variables
...
.head 3 +  Group Box Class: clsgbGeneral
